...
//Liste des étudiants
Route::get('/listeuser/etudiant',[\App\Http\Controllers\AdminController::class,'filtrerUtilisateursEtudiant'])->name('filtrerutilisateursetudiant')->middleware('is_admin');
